...
\documentclass[a4paper,twocolumn,oneside,12pt]{memoir}
...
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{calc,intersections,angles,positioning,patterns}
...
\NewDocumentCommand{\monster}{m}{\textbf{\textit{\mbox{#1}}}}
\NewDocumentCommand{\rollcheck}{mO{}}{\textbf{\mbox{#1#2}}}
